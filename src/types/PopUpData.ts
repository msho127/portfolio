...
export const popUpData: PopUpData[] = [
  ...
  },
  {
    ...
    additionalInfo: "はじめてnext.jsを使用した作品です。reactなど使用していなかったため作成当初はcssを書くだけで一苦労でした。この頃にgptを活用したコードの勉強法を学び、その後はスムーズにコーディングが進むようになりました。この作品ではnextのライブラリをいくつか使用したことで制作期間を大幅に時短できました。",
    outlook : "",
...
//     additionalInfo: "詳細：タンスの肥やしになっている行事用具をお金に変えれないか、会社など一時のイベントでしか使わないので購入は勿体ないという方に向けたサービスです。</br>このサービスでは宅配サービスも提供しており、高齢者や体の不自由な方、忙しい方でも安心してご利用いただけます。また、インターネットから簡単にご注文いただけるため、時間のない方にも便利です。",
//     outlook : "",
...
//     teamInfo: "チーム制作(4人/企画、フロント画面担当)",
//     targetAudience: "ターゲット:中学生、高校生",
//     additionalInfo: "詳細：様々なシチュエーションをテーマとして設定し、その中にさらに細かい項目を設けることで、日々の学習テーマを明確にし、目標達成に向けて取り組みやすくしています。これにより、コミュニケーションを取る機会も自然と増えると考えています。",
//     outlook : "",
//     link: "https://commuland.vercel.app/",
//   }
